...
namespace RealEstateInvestment.MigrationsDb.dbContainer
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RealEstateInvestment.Areas.RealEstate.Models.dbContainer>
    {
        ...
        protected override void Seed(RealEstateInvestment.Areas.RealEstate.Models.dbContainer context)
        {
            ...
            context.PaymentMethodHeaders.AddOrUpdate(p => p.Id, new PaymentMethodHeader { Id = 1000, Name = "äÙÇã ÏİÚ ÎÇÕ", TotalMonthPeriod = 0 });
            ...
            //, new PaymentType { Id = 1, Name = "ÏİÚÉ ÊÚÇŞÏ", PaymentTypePropertyId = 1}
            //, new PaymentType { Id = 2, Name = "ÏİÚÉ Ãæáì" }
            //, new PaymentType { Id = 3, Name = "ÏİÚÉ ÇÓÊáÇã" }
            //, new PaymentType { Id = 4, Name = "ÏİÚÉ ÕíÇäÉ", PaymentTypePropertyId = 2 }
            //, new PaymentType { Id = 5, Name = "ÃŞÓÇØ ÑÈÚ ÓäæíÉ" }
            //, new PaymentType { Id = 6, Name = "ÏİÚÉ ËÇäíÉ" }
            //, new PaymentType { Id = 7, Name = "ÇáÏİÚÉ ÇáËÇáËÉ" }
            //, new PaymentType { Id = 8, Name = "ÇáÏİÚÉ ÇáÑÇÈÚÉ" }
            //);
            ...
            //context.PaymentMethodHeaders.AddOrUpdate(p => p.Id, new PaymentMethodHeader { Id = 1, Name = "6 ÓäæÇÊ", TotalMonthPeriod = 6 });
            //context.PaymentMethodHeaders.AddOrUpdate(p => p.Id, new PaymentMethodHeader { Id = 1000, Name = "äÙÇã ÏİÚ ÎÇÕ", TotalMonthPeriod = 0 });
