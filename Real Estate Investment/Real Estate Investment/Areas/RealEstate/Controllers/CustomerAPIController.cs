...
namespace RealEstateInvestment.Areas.RealEstate.Controllers
{
    ...
    public class CustomerAPIController : ApiController
    {
        ...
        [HttpPost]
        [Route("CustomerAccountOperation")]
        public JsonResult<AccountOperationResult> CustomerAccountOperation(AccountOperationParams model)
        {
        ...
        [HttpPost]
        [Route("CreateJournalEntries")]
        public JsonResult<CreateJournalEntriesResult> CreateJournalEntries(CreateJournalEntriesParams model)
        {
            string connectionString = HandelConnectionStrings.GetConnectionString(model.CompanyName);
            DataTable dataTable = new DataTable();
        ...
        [HttpPost]
        [Route("PayRealEstateInstallment")]
        public JsonResult<CreateJournalEntriesResult> PayRealEstateInstallment(PayRealEstateInstallmentParams model)
        {
            string connectionString = HandelConnectionStrings.GetConnectionString(model.CompanyName);
            DataTable dataTable = new DataTable();
